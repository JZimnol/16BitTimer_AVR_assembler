...
;                        BUTTONS                        ;
;-------------------------------------------------------;
; S1  - increment first digit                           ;
; S2  - increment second digit                          ;
; S3  - increment third digit                           ;
; S4  - increment fourth digit                          ;
; S5  - decrement first digit                           ;
; S6  - decrement second digit                          ;
; S7  - decrement third digit                           ;
; S8  - decrement fourth digit                          ;
; S13 - start counting                                  ;
; S16 - reset program                                   ;
;-------------------------------------------------------;
...
countdown_100_percent:                 ; start counting for sure
        pop r16
        ldi comparator, 0xff           ; set comparator to 0xff and use it in countdown loop
        ldi  reset_flag, 0xfe
        call countdown
...
decode:
        ...
        or keyboard_value, r29             ; r17 b0:b3 contains column number, b4:b7 contains row number   
        ...
        cp keypad_block, comparator        ; if keypad_block == comparator => don't incement or decrement, allow reset only
        brne s1_check                      ; if keypad_block != comparator => allow interrupt execution 
        jmp s16_check                        
